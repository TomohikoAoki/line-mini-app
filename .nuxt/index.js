...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"LIFF Starter","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (process.client && typeof nuxt_plugin_liffinitclient_46eda6f0 === 'function') {
    await nuxt_plugin_liffinitclient_46eda6f0(app.context, inject)
  }
